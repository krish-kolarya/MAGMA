...
let transparentClick = document.querySelector(".transparentClick");
let count = 0;
...
function menuOpen(){  
  if(count %2 == 0)
  {
    ...
    menubutton.innerHTML = `<i class="ri-menu-fill"></i>`;
    transparentScreen2();
  }
  count++;
}

function transparentScreen1(){
  transparentClick.style.display = 'block'; 
}

function transparentScreen2(){
  transparentClick.style.display = 'none';
}
...
document.querySelector("#nav-btn-js-1").addEventListener("mouseover", () => {
  const btn_t = gsap.timeline();
  btn_t
  .to("#nav-btn-2", {
    y:"-100%",
    ease: "expo.inOut",
...
document.querySelector("#nav-btn-js-1").addEventListener("mouseleave", () => {
  const btn_t = gsap.timeline();
  btn_t
  .to("#nav-btn-2", {
    y:"0",
...
document.querySelector("#nav-btn-js-2").addEventListener("mouseover", () => {
  const btn_t = gsap.timeline();
  btn_t
  .to("#nav-btn-4", {
    y:"-100%",
...
document.querySelector("#nav-btn-js-2").addEventListener("mouseleave", () => {
  const btn_t = gsap.timeline();
  btn_t
  .to("#nav-btn-4", {
    y:"0",
...
gsap.to("#one-container>#one-container-a",{
  scrollTrigger:{
    trigger:"#one-container>#one-container-a",
    start:"top 50%",
    end:"top 30%",
    scroller:"#main",
    scrub: .0001
...
gsap.to("#one-container>#one-container-b",{
  scrollTrigger:{
    trigger:"#one-container>#one-container-b",
    start:"top 50%",
    end:"20% top",
    scroller:"#main",
    scrub: .0001
...
gsap.to("#one-container>#one-container-c",{
  scrollTrigger:{
    trigger:"#one-container>#one-container-c",
    start:"top 50%",
    end:"top center",
    scroller:"#main",
    scrub: 5
...
gsap.to("#one-container>#one-container-d",{
  scrollTrigger:{
    trigger:"#one-container>#one-container-d",
    start:"top 50%",
    end:"20% top",
    scroller:"#main",
    scrub: .0001
...
function canvas3(){
  const canvas = document.querySelector("#one-left>canvas");
  const context = canvas.getContext("2d");
...
var hRatio = canvas.width / img.width;
var vRatio = canvas.height / img.height;
var ratio = Math.max(hRatio/1.2, vRatio/1.2);
